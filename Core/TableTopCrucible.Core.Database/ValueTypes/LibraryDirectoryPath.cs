...
namespace TableTopCrucible.Core.Database.ValueTypes
{
    ...
    {
        public static readonly RelativeDirectoryPath RelativeWorkingDirectoryPath =
            RelativeDirectoryPath.From(@"~TableTopCrucible");

        public static LibraryDirectoryPath From(DirectoryPath dirPath) => new() {Value = dirPath.Value};
