...
{
    public ExceptionNotification(Exception exception, Name title = null, Description content = null,
        NotificationType type = NotificationType.Error, NotificationIdentifier identifier = null)
    {
        Type = type;
