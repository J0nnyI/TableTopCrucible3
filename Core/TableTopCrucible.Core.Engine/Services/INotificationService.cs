...
namespace TableTopCrucible.Core.Engine.Services
{
    ...
    public interface INotificationService
    {
        ...
        NotificationId AddWarning(Exception exception, Name title = null, Description content = null, NotificationIdentifier identifier = null);
        NotificationId AddError(Name title, Description content, NotificationIdentifier identifier = null, Exception exception = null);
        NotificationId AddError(Exception exception, Name title = null, Description content = null, NotificationIdentifier identifier = null);
    }
    ...
    public class NotificationService : INotificationService
    {
        ...
        public NotificationId AddWarning(
            ...
            NotificationIdentifier identifier = null)
            => _addNotification(new ExceptionNotification(exception, title, content, NotificationType.Warning, identifier));
        ...
        public NotificationId AddError(
            ...
            Description content = null,
            NotificationIdentifier identifier = null)
            => _addNotification(new ExceptionNotification(exception, title, content, NotificationType.Error, identifier));
