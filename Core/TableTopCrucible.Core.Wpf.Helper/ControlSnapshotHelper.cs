...
public static class VisualRender
{
    ...
    private static async Task<BitmapSource> RenderAsync(Brush brush, Rect helperWindowLocation, Size snapshotSize)
    {
        ...
        {
            var bitmap = VisualToBitmapConverter.GetBitmap(handle,
    ...
    public static class VisualToBitmapConverter
    {
        ...
        public static Bitmap GetBitmap(IntPtr hwnd, int width, int height)
        {
            ...
            using (var graphicsFromVisual = Graphics.FromHwnd(hwnd))
            {
                using (var graphicsFromImage = Graphics.FromImage(bitmap))
                {
                    var source = graphicsFromVisual.GetHdc();
                    var destination = graphicsFromImage.GetHdc();
