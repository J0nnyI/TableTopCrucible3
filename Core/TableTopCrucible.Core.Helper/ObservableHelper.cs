...
namespace TableTopCrucible.Core.Helper
{
    ...
    public static class ObservableHelper
    {
        ...
        public static IObservable<TimeSpan> StartTimer(this TimeSpan forTime, IObservable<bool> isRunningChanges = null,IObservable<Unit>cancel = null, TimeSpan? resolution = null, IScheduler scheduler = null)
        {
            ...
            return Observable.Interval(incrementSize, scheduler ?? Scheduler.CurrentThread)
                ...
                .Scan(forTime,(acc, isRunning) 
                    => isRunning ? acc - incrementSize : acc)
