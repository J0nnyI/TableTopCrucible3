...
public class TabSelectionInfo : ReactiveObject, IDisposable
{
    ...
    public TabSelectionInfo(ITabPage content, IObservable<ITabPage> selectedTabChanges,
        ReactiveCommand<ITabPage, Unit> onClickCommand)
    {
        Content = content;
        ...
        isSelectedChanges.Subscribe(selected =>
            OnClickCommand.Execute(selected
                ? Content
                : null));
