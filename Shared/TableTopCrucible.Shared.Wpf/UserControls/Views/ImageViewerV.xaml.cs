    ...
    public partial class ImageViewerV : ReactiveUserControl<ImageViewerVm>
    {
        public ImageViewerV()
        {
            ...
            this.WhenActivated(() => new[]
            {
                ...
                Observable.Select<, Visibility>(this.WhenAnyValue(v => v.ViewModel.ImageSource), img => img is null
                        ? Visibility.Visible
                ...
                Observable.Select<, Visibility>(this.WhenAnyValue(v => v.ViewModel.ImageSource), img => img is not null
                        ? Visibility.Visible
                        : Visibility.Collapsed)
                    .ObserveOn(RxApp.MainThreadScheduler)
